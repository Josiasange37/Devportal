export default function HowItWorks() {
    ...
    return (
        <section id="how-it-works" className="py-24 bg-secondary/30 transition-colors duration-300">
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-card p-8 rounded-[2rem] border border-border flex flex-col items-center text-center relative hover:-translate-y-2 transition-transform duration-300 shadow-sm hover:shadow-xl hover:shadow-primary/5">
                                <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center text-primary-foreground mb-6 shadow-lg shadow-primary/30 relative z-10">
