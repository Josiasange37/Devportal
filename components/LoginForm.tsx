                ...
                <form onSubmit={handleSubmit} className="relative z-10">
                    ...
                    {internalIsLogin && (
                        <div className="animate-in fade-in slide-in-from-bottom-8 duration-500">
                            <h2 className="text-3xl font-bold text-foreground mb-2 font-sans">Welcome Back</h2>
                            <p className="text-muted-foreground mb-8">Sign in to your dashboard</p>

                            <div className="space-y-6 mb-8">
                                <div className="relative group">
                                    <label className="text-xs font-bold text-primary uppercase tracking-widest absolute -top-2 left-4 bg-card px-2">Email</label>
                                    <input
                                        type="email"
                                        required
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full py-4 bg-primary text-primary-foreground rounded-2xl font-bold text-lg hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-1 active:scale-95 transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
                            >
                                {isLoading ? (
                ...
                {(internalIsLogin || step === 1) && (
                    <div className="mt-8 pt-8 border-t border-border/50 animate-in fade-in duration-700 delay-200">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 py-3 border border-border rounded-xl hover:bg-secondary transition-colors text-foreground font-medium text-sm disabled:opacity-50">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 py-3 border border-border rounded-xl hover:bg-secondary transition-colors text-foreground font-medium text-sm"
                            >
